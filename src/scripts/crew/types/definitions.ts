...
export const SPECIALIZATION_DEFAULT_KEYS = ['captain', 'quartermaster',
  'master', 'master-mate', 'bosun', 'bosun-mate', 'gunner', 'gunner-mate',
  'carpenter', 'carpenter-mate', 'surgeon', 'surgeon-mate', 'cooper',
  'cooper-mate', 'armorer', 'armorer-mate', 'sailmaker', 'sailmaker-mate',
  'cook']
...
export const createSpecializationDefinitions = (): SpecializationDefinitions => {
  ...
  for (const key of SPECIALIZATION_DEFAULT_KEYS) record[key] = createSpecializationDefinitionFromKey(key)
  return record
}
